...
void* computeSum(void* args) {
    int *index = (int*) args;
    int myrows = (*index)/MAX;
    int ourcolumn = (*index)%MAX;
	
    matSumResult[myrows][ourcolumn] = matA[myrows][ourcolumn] + matB[myrows][ourcolumn];
}
...
void* computeDiff(void* args) {
    ...
    matDiffResult[myrows][ourcolumn] = matA[myrows][ourcolumn] - matB[myrows][ourcolumn];
}
...
void* computeProduct(void* args) {
    ...
    matProductResult[myrows][ourcolumn] = matA[myrows][ourcolumn] * matB[myrows][ourcolumn];
}
...
int main() {
    ...
    for(int i = 0; i < 3; i++){
        ...
        *operation_id = i;
        ...
        pthread_create(&objects[*operation_id][*index], NULL, opers[*operation_id], (void*)index);
      }
    }
